...
VALUES ('Sport'), ('Classic'), ('SUV'), ('Luxury'), ('Vintage');

-- 6. Insert into inventory table (from inventory-data.txt)
...
-- 11. Task 1 - Select inventory with classification name (JOIN)
